...
class CookieFieldGridDefinitionFactory extends AbstractGridDefinitionFactory
{
    const GRID_ID = 'ds_cookie_cookie_field';
    ...
    {
        return $this->trans('Cookie fields', [], 'Modules.DsGprdCookie.Admin');
    }
            ...
            ->add(
                (new Filter('cookie_category', ChoiceType::class, [
                    ...
                    ->setTypeOptions([
                        'required' => false,
                        'attr' => [
                            'placeholder' => $this->trans('Category', [], 'Modules.DsGprdCookie.Admin'),
                        ],
                    ])
                    ->setAssociatedColumn('cookie_category')
            )
            ->add(
                (new Filter('cookie_name', TextType::class))
                    ->setTypeOptions([
                        'required' => false,
                        'attr' => [
                            'placeholder' => $this->trans('Cookie name', [], 'Modules.Demogrid.Admin'),
                        ],
                    ])
            ...
            ->add(
                (new Filter('enabled', TextType::class))
                    ->setTypeOptions([
                        'required' => false,
                        'attr' => [
                            'placeholder' => $this->trans('Enabled', [], 'Modules.Demogrid.Admin'),
                        ],
                    ])
